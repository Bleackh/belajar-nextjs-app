        ...
        <div className="h-screen w-100 flex justify-center items-center">
            <div
                ...
                <form className="space-y-6" action="#">
                    ...
                    <div>
                        <label htmlFor="email" className="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Your Full Name</label>
                        <input type="text" name="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Your Full Name" required />
                    </div>
                    <div>
                    ...
                    <div className="flex items-start">
                        ...
                        <Link href="register" className="text-sm text-blue-700 hover:underline ml-auto dark:text-blue-500">Lost
                            Password?</Link>
                    </div>
                    ...
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                        Not registered? <Link href="/login" className="text-blue-700 hover:underline dark:text-blue-500">Have Registered?</Link>
                    </div>
                </form>
            </div>
        </div>
